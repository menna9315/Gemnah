(function($) {
                            ...
                            if(isResizing) {
                                ...
                                if($window.scrollTop() > lastScroll) {
                                    ...
                                    if($window.width() < 1200) {
                                        ...
                                        HeaderTarget.find(showHeaderBottom).css({"transform": "translateY(0px)","transition": "transform 0.3s ease"});
                                    }
                        ...
                        $window.on("resize", function() {
                            ...
                            resizeTimeout = setTimeout(function() {
                                ...
                                if(HeaderTarget.hasClass("header-sticky")) {
                                    ...
                                    HeaderTarget.find(targetShowBottom).css({"transition": "transform 0.3s ease"});
                                }
    ...
    ST.productList = {
        ...
        productList1: function() {
            var swiper = new Swiper('.swiper#product-list1-slider', {
                loop: false,
                rewind: true,
                slidesPerView: 1,
                grid: {
                ...
                watchSlidesProgress: true,
                navigation: {
                    prevEl: '.swiper-prev-product-list1',
                    nextEl: '.swiper-next-product-list1'
                },
                pagination: {
                    el: ".swiper-pagination-product-list1",
                    clickable: true
                },
                autoplay: {
                    delay: 5000,
        ...
        productList2: function() {
            var swiper = new Swiper('.swiper#product-list2-slider', {
                loop: false,
                rewind: true,
                slidesPerView: 1,
                grid: {
                ...
                watchSlidesProgress: true,
                navigation: {
                    prevEl: '.swiper-prev-product-list2',
                    nextEl: '.swiper-next-product-list2'
                },
                pagination: {
                    el: ".swiper-pagination-product-list2",
                    clickable: true
                },
                autoplay: {
                    delay: 5000,
        ...
        productList3: function() {
            var swiper = new Swiper('.swiper#product-list3-slider', {
                loop: false,
                rewind: true,
                slidesPerView: 1,
                grid: {
                ...
                watchSlidesProgress: true,
                navigation: {
                    prevEl: '.swiper-prev-product-list3',
                    nextEl: '.swiper-next-product-list3'
                },
                pagination: {
                    el: ".swiper-pagination-product-list3",
                    clickable: true
                },
                autoplay: {
                    delay: 5000,
