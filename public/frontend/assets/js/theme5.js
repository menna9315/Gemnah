(function($) {
    ...
    var ST = {
        ...
        footerJs: function() {
            // footer-link js
            function adjustArrowPosition() {
                var $slideHeight = $(".footer-link-wrap .swiper-slide"),
                    $buttonsHeight = $(".footer-link-wrap .swiper-buttons button");
                if($slideHeight.length && $buttonsHeight.length) {
                    var $sliderHeight = $slideHeight.height(),
                        $buttonHeight = $buttonsHeight.outerHeight();
                    if($sliderHeight && $buttonHeight) {
            ...
            adjustArrowPosition();
            var swiper = new Swiper('.swiper#footer-link-slider', {
                loop: false,
                rewind: true,
                slidesPerView: 6,
                spaceBetween: 30,
                ...
                watchSlidesProgress: true,
                navigation: {
                    prevEl: '.swiper-prev-footer-link',
                    nextEl: '.swiper-next-footer-link'
                },
                pagination: {
                    el: ".swiper-pagination-footer-link",
                    clickable: true,
                },
                autoplay: {
                    delay: 5000,
            ...
            var homeslider = new Swiper('.swiper#home-slider', {
                ...
                pagination: {
                    ...
                    renderBullet: function (index, className) {
                        const labels = ["desk stool", "armchair", "bedroom", "sofaset"];
                        return '<span class="' + className + '"><a href="collection.html">Shop now</a>' + labels[index] + '</span>';
                    }
                },
                autoplay: {
                    delay: 5000,
