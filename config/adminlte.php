...
return [
    ...
    */
    ...
    'logo' => '',
    'logo_img' => 'images/gemnah-mark.png',
    'logo_img_class' => 'gemnah-logo-xs',
    'logo_img_xl' => 'images/gemnah-logo.png',
    'logo_img_xl_class' => 'gemnah-logo-xl',
    'logo_img_alt' => 'GEMNAH Logo',
    ...
    */
    ...
    'classes_body' => '',
    'classes_brand' => 'gemnah-brand',
    'classes_brand_text' => '',
    'classes_content_wrapper' => '',
    'classes_content_header' => '',
    'classes_content' => '',
    'classes_sidebar' => 'sidebar-dark-primary gemnah-sidebar elevation-4',
    'classes_sidebar_nav' => '',
    'classes_topnav' => 'navbar-white navbar-light gemnah-topnav',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active' => ['backend/collections*'],
        ],
        [
            'text' => 'Product Features',
            'icon' => 'fas fa-fw fa-sliders-h',
            'active' => ['backend/colors*', 'backend/sizes*'],
            'submenu' => [
                [
                    'text' => 'Colors',
                    'route' => 'backend.colors.index',
                    'icon' => 'fas fa-fw fa-palette',
                    'active' => ['backend/colors*'],
                ],
                [
                    'text' => 'Sizes',
                    'route' => 'backend.sizes.index',
                    'icon' => 'fas fa-fw fa-ruler-combined',
                    'active' => ['backend/sizes*'],
                ],
            ],
        ],
        [
